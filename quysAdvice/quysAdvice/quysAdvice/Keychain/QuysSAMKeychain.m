...
NSString *const kSAMKeychainErrorDomain = @"com.samsoffes.QuysSAMKeychain";
...
@implementation QuysSAMKeychain
...
+ (nullable NSString *)passwordForService:(NSString *)serviceName account:(NSString *)account error:(NSError *__autoreleasing *)error {
	QuysSAMKeychainQuery *query = [[QuysSAMKeychainQuery alloc] init];
