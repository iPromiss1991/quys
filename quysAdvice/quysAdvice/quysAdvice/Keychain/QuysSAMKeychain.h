...
/**
 Error code specific to QuysSAMKeychain that can be returned in NSError objects.
...
/**
 ...
 QuysSAMKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface QuysSAMKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in QuysSAMKeychain.h for a list of keys that can be used when accessing the
